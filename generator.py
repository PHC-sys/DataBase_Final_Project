...
def initial_leftover_generator(days_meal):
    ...
    for day in range(days_interval):
        ...
        leftover['Initial_Weight'].append(str(initial_weight)+weight_unit)
        ...
        leftover['Wasted_Ratio'].append(end_weight/actual_demand)
        leftover['Wasted_Cost'].append(str(end_weight*130)+cost_unit)
